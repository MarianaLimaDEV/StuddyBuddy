...
faq1A: { pt: 'Abre o menu <strong>Login</strong>, escreve o teu email e password, e confirma. Se ainda não existir conta, o sistema cria automaticamente.', en: 'Open the <strong>Login</strong> menu, enter your email and password, and confirm. If no account exists yet, the system creates one automatically.' },
  faq2Q: { pt: 'Como alterar o tema (claro/escuro)?', en: 'How do I change the theme (light/dark)?' },
faq2A: { pt: 'Vai em <strong>Configurações</strong> e muda o <strong>Tema</strong>. Ao estar conectado, o tema é guardado para a próxima vez.', en: 'Go to <strong>Settings</strong> and change the <strong>Theme</strong>. When connected, the theme is saved for next time.' },
...
faq4A: { pt: 'Sim: as <strong>configurações</strong> ficam associadas ao teu email. As ferramentas podem ter comportamentos diferentes dependendo do módulo.', en: 'Yes: <strong>settings</strong> are associated with your email. Tools may behave differently depending on the module.' },
  faq5Q: { pt: 'Posso abrir várias ferramentas ao mesmo tempo?', en: 'Can I open several tools at once?' },
faq5A: { pt: 'Sim. Podes abrir mais do que um card e organizar no ecrã. Exemplo: Pomodoro + TaskList lado a lado.', en: 'Yes. You can open more than one card and arrange them on screen. Example: Pomodoro + TaskList side by side.' },
  faq6Q: { pt: 'Perdi a password. E agora?', en: 'I forgot my password. What now?' },
faq6A: { pt: 'Clica em <strong>Forgot password?</strong> e segue as instruções. (Ainda pode ser uma funcionalidade futura.)', en: 'Click <strong>Forgot password?</strong> and follow the instructions. (May be a future feature.)' },
